...
/** Recommended transaction fee by Dogecoin Core developers
  ...
  */
static const CAmount RECOMMENDED_MIN_TX_FEE = 1000;
 ...
 *
 *  luckycoin:    Increment mempool limits and accept RBF in steps of 0.0001 DOGE
...
/**
 * luckycoin: Default dust limit that is evaluated when considering whether a
...
/**
 * luckycoin: Default hard dust limit that is evaluated when considering whether
